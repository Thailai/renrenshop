...
<div class="fui-page fui-page-current">
    ...
    <div class="fui-content" >
        ...
        <div class="fui-block-group col-3" style='margin-top:0; overflow: hidden;'>
            <a class="fui-block-child external" href="<?php  echo mobileUrl('globonus/bonus')?>">
            ...
            <a class="fui-block-child external" href="<?php  echo mobileUrl('globonus/bonus',array('status'=>2))?>">
            ...
            <a class="fui-block-child external" href="<?php  echo mobileUrl('globonus/bonus',array('status'=>1))?>">
